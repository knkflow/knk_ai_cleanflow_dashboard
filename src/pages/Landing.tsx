...
export function Landing() {
  ...
  {/* Subtiler Glow um den Text */}
  <span
    aria-hidden
    className="pointer-events-none absolute -inset-x-4 -inset-y-1 rounded-full
               bg-[radial-gradient(80%_80%_at_50%_50%,rgba(255,255,255,0.4),transparent_80%)]
