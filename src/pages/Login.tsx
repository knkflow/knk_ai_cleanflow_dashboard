...
import { LogIn, MessageSquare, CalendarDays, ShieldCheck, Eye, EyeOff, Shield } from 'lucide-react';
...
export function Login() {
  ...
  return (
    <div className="relative min-h-screen text-white overflow-hidden">
      ...
      <div
        className="pointer-events-none absolute -top-48 -left-48 h-[60rem] w-[60rem] rounded-full blur-3xl opacity-50"
        style={{ background: 'radial-gradient(40% 40% at 50% 50%, #10B981 0%, rgba(16,185,129,0.0) 60%)' }}
      />
      <div
        className="pointer-events-none absolute -bottom-64 -right-80 h-[60rem] w-[60rem] rounded-full blur-3xl opacity-40"
        style={{ background: 'radial-gradient(40% 40% at 50% 50%, #8B5CF6 0%, rgba(139,92,246,0.0) 60%)' }}
      />
      <div
        className="pointer-events-none absolute inset-0 opacity-[0.15]"
        style={{ backgroundImage: 'conic-gradient(from 90deg at 50% 50%, #00E5FF, #10B981, #F97316, #FF3D71, #8B5CF6, #00E5FF)' }}
      />
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-start">
          ...
          <section className="hidden lg:block">
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 via-fuchsia-400 to-indigo-400">
                Klar. Mutig. Markant.
              </span>
            </h1>
            ...
            <div className="mt-10 grid sm:grid-cols-2 gap-6 max-w-2xl">
              {[
                { icon: MessageSquare, title: 'WhatsApp an Teams', text: 'Aufträge, Updates und Erinnerungen automatisch oder manuell senden – nachvollziehbar und zentral dokumentiert.' },
          ...
          <section className="w-full max-w-md lg:ml-auto mx-auto">
            <div className="relative rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="relative space-y-4 px-6 pt-5 pb-7">
                ...
                >
                  <span
                    className="absolute -inset-[1px] rounded-xl bg-gradient-to-r from-emerald-500 via-fuchsia-500 to-indigo-500 blur-[6px] opacity-70 group-hover:opacity-90 transition"
                    aria-hidden
                  />
...
// <-- ergänze das, falls du irgendwo `import Login from ...` nutzt
