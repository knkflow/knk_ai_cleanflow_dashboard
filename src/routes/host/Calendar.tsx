...
export function Calendar() {
  ...
  /* ---- renderDay ----
     Desktop: wirkt wie vorher, nur mit schwarzem Look, feinen Linien, abgerundet & leicht „erhöht“.
     Mobile: kompakter; keine Texte/Badges; nur Farbcode rot/grün; Button zeigt nur Icon (Text hidden).
  */
  const renderDay = useCallback(
    (day: MonthDay) => {
      ...
      // In All-View: keine Namen/Badges, nur Farbe.
      ...
      return (
        <div className={`h-full ${day.isCurrentMonth ? '' : 'opacity-40'} select-none`}>
          ...
          {/* Tages-Kachel: schwarz, rund, feine Linien + zarter Shadow */}
          {day.isCurrentMonth && (
            <div
              className={`
              ...
              `}
            >
              {/* Desktop: „Verfügbar“ im grünen Kasten; Mobile: gleich */}
              {!isUnavailable && <div className="truncate text-center">Verfügbar</div>}

              {/* All-View: KEINE Namensliste / KEIN Badge */}
  ...
  return (
    <div>
      ...
      {/* SCHWARZE KALENDER-CARD mit feinen weißen Linien + Erhöhung */}
